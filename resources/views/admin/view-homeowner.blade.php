...
<head>
    ...
    <title>View Homeowner | GardenCare</title>
    ...
    <div class="container py-5">
        <div class="greenspace-card">
            <div class="greenspace-card-header">
                <h1 class="h4 mb-0"><i class="bi bi-house-door"></i> Homeowner Details</h1>
            </div>
                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        <div class="detail-item">
                            <p class="d-flex align-items-center">
                                ...
                                <strong>Email:</strong> &nbsp;{{ $homeowner->email }}
                            </p>
                        </div>
                        <div class="detail-item">
                            <p class="d-flex align-items-center">
                                <i class="bi bi-telephone-fill detail-icon"></i>
                                <strong>Phone:</strong> &nbsp;{{ $homeowner->phone }}
                            </p>
                        </div>
                        <div class="detail-item">
                            <p class="d-flex align-items-center">
                                <i class="bi bi-geo-alt-fill detail-icon"></i>
                                <strong>Address:</strong> &nbsp;{{ $homeowner->address }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="text-center mt-4">
                    <a href="{{ route('admin.manageHomeowners') }}" class="btn btn-greenspace px-4">
