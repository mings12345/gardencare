...
<head>
    ...
    <title>Manage Service Providers | GardenCare</title>
...
<body>
    <div class="container">
        ...
        <div class="header-container">
            ...
            <h1><i class="fas fa-tools me-2"></i> Manage Service Providers</h1>
            <div>
                <a href="{{ route('admin.addServiceProvider') }}" class="btn btn-success btn-add">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td data-label="Address">{{ $serviceProvider->address ?? 'N/A' }}</td>
                            <td data-label="Actions" class="action-buttons">
                                <!-- View Button -->
                                <a href="{{ route('admin.viewServiceProvider', $serviceProvider->id) }}" class="btn btn-info btn-sm" title="View">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <!-- Edit Button -->
                                <a href="{{ route('admin.editServiceProvider', $serviceProvider->id) }}" class="btn btn-warning btn-sm" title="Edit">
                                ...
                                <form action="{{ route('admin.deleteServiceProvider', $serviceProvider->id) }}" method="POST" style="display: inline-block;">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger btn-sm" title="Delete" onclick="return confirm('Are you sure you want to delete this service provider?')">
