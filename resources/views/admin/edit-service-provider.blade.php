...
<head>
    ...
    <title>Edit Service Provider | Greenspace</title>
            ...
            <div class="col-lg-8">
                <div class="greenspace-card">
                    <div class="greenspace-card-header">
                        <h1 class="h4 mb-0"><i class="bi bi-tools me-2"></i>Edit Service Provider</h1>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('admin.updateServiceProvider', $serviceProvider->id) }}" enctype="multipart/form-data">
                            ...
                            <!-- Add profile image upload section -->
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" id="name" name="name" 
                                       value="{{ old('name', $serviceProvider->name) }}" required>
                            </div>
                            <div class="mb-4">
                                <label for="email" class="form-label">Email Address</label>
                                <input type="email" class="form-control" id="email" name="email" 
                                       value="{{ old('email', $serviceProvider->email) }}" required>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="d-flex justify-content-between mt-5">
                                <a href="{{ route('admin.manageServiceProviders') }}" class="btn btn-outline-greenspace">
                                    <i class="bi bi-arrow-left me-1"></i> Cancel
                                </a>
                                <button type="submit" class="btn btn-greenspace">
                                    <i class="bi bi-save me-1"></i> Update Service Provider
                                </button>
                            </div>
                        </form>
                    </div>
