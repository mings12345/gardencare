...
<body>
    <div class="container mt-5">
        ...
        <!-- Edit Form -->
        <form action="{{ route('admin.updateServiceProvider', $serviceProvider->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $serviceProvider->address) }}">
            </div>
            <button type="submit" class="btn btn-primary">Update</button>
            <a href="{{ route('admin.manageServiceProviders') }}" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
